...
class SSMDocumentLustrePreload(Construct):
    ...
    def __init__(
        ...
        ssm_assume_role = iam.Role(
            ...
            role_name="batch-ffmpeg-ssm-assume-role",
                    ...
                    statements=[
                        iam.PolicyStatement(
                            ...
                            resources=[
                                ...
                                + ":iam::"
                                + aws.ACCOUNT_ID
                                + ":role/batch-ffmpeg-ssm-ec2-instance-role"
                            ],
                        )
                    ]
                )
        ...
        ec2_ssm_role = iam.Role(
            ...
            role_name="batch-ffmpeg-ssm-ec2-instance-role",
            assumed_by=iam.CompositePrincipal(
        ...
        ec2_ssm_instance_profile = iam.InstanceProfile(
            ...
            instance_profile_name="batch-ffmpeg-ssm-ec2-instance-profile",
            role=ec2_ssm_role,
        )
