CREATE OR REPLACE VIEW batch_ffmpeg.batch_ffmpeg_xray_subsegment AS
SELECT
    trace_id,
...
FROM batch_ffmpeg.batch_ffmpeg_xray
CROSS JOIN UNNEST(batch_ffmpeg.batch_ffmpeg_xray.subsegments) AS t(subsegment)
